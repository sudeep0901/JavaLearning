...
//		JPA calls them embeddables
		...
		DormentAccount da = new DormentAccount();
		da.setBalance(200.00);
		da.setInterestRate(8.0);
		da.setDorment(true);
		da.setOwner("renu Patel");
		...
		List<Account> accounts = manager.createQuery("select a from AccountSingleTable a ").getResultList();
		transaction.begin();
