...
public class JdbcIntegradientRepository implements IngredientRepository {
	...
	public Iterable<Ingredient> findAll() {
		...
		return jdbc.query("select id, name, type from taco_Ingredient", this::mapRowToIngredient);
	}

	@Override
	public Ingredient findOne(String id) {
		// TODO Auto-generated method stub
		return jdbc.queryForObject("select id, name, type from taco_Ingredient where id=?", this::mapRowToIngredient, id);
	}
	...
	public Ingredient save(Ingredient ingredient) {
		...
		jdbc.update("insert into taco_Ingredient(id, name, type) values (? ,? ,?)", ingredient.getId(), ingredient.getName(),
	...
	public Ingredient findOnee(String id) {
		return jdbc.queryForObject("select id, name, type from taco_Ingredient where id=?", new RowMapper<Ingredient>() {
